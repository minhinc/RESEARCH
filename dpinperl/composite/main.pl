...
$frameleftref->add(new combobox("comboleft", "one", "two", "three"), new button("buttonleft", "OK"));
$framerightref->add(new combobox("comboright", "animal", "bird", "reptile"), new button("buttonright", "OK"));
